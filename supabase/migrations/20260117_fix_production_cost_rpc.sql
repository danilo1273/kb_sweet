-- Secure Production RPCs - Fix for Zero Cost (Fallback Logic)
-- Replaces close_production_order_secure to use cost_danilo/cost_adriel if cost is 0
...
DECLARE
    ...
    v_base_cost NUMERIC; -- New variable for fallback logic
    ...
    LOOP
        ...
        IF v_item_record.type = 'ingredient' THEN
            ...
            IF FOUND THEN
                ...
                -- Execute Deduction
                UPDATE ingredients 
                SET stock_danilo = stock_danilo - v_qty_to_deduct -- Assuming Danilo stock for now
